	...
	<div class="main__affairs">
		...
		<div 
			...
			<div class="body" :class="{ green: item.progress }">
				...
				<div class="item_btn ready" @click.prevent="$emit('updateProgress', item.listId, item.id, item.progress)">
				...
				<div class="item_btn add-item" @click.prevent="$emit('createSubtask', item.listId, item.id, item.title)">
